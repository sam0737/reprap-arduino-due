        ...
        .joints = (RadJoint[]) {
          {
            ...
            .max_velocity = 400, .max_acceleration = 800, .scale = 1000, //45.7142,
          ...
          },
          {
            ...
            .max_velocity = 400, .max_acceleration = 2500, .scale = 1000, //45.7142,
            .home_search_vel = -75, .home_latch_vel = 2,
            .home_sequence = 0
          },
          {
            ...
            .max_velocity = 20, .max_acceleration = 100, .scale = 1000, //45.7142,
