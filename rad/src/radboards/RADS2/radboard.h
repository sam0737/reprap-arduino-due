 ...
 */
#define RADBOARD_NAME "RADS2"
#define RADBOARD_RADS2        TRUE
 ...
 */
#define RAD_NUMBER_ENDSTOPS   5

/**
 * @brief Define number of stepper outputs
 */
#define RAD_NUMBER_STEPPERS   6

/**
 * @brief Define number of PWM outputs
 */
#define RAD_NUMBER_OUTPUTS    6
...
#define RADBOARD_EXTRUDER_3_STEPPER   5

#define RADBOARD_EXTRUDER_1_OUTPUT    0
#define RADBOARD_EXTRUDER_2_OUTPUT    1
#define RADBOARD_EXTRUDER_3_OUTPUT    2
#define RADBOARD_BED_OUTPUT           6

#define RADBOARD_EXTRUDER_1_TEMP_ADC  1
#define RADBOARD_EXTRUDER_2_TEMP_ADC  2
#define RADBOARD_EXTRUDER_3_TEMP_ADC  3
#define RADBOARD_BED_TEMP_ADC         0
#define RADBOARD_SYSTEM_TEMP_ADC      4

#define RADBOARD_STEPPER_1_REF_ADC    5
#define RADBOARD_STEPPER_2_REF_ADC    6
#define RADBOARD_STEPPER_3_REF_ADC    7
#define RADBOARD_STEPPER_4_REF_ADC    8
#define RADBOARD_STEPPER_5_REF_ADC    9
#define RADBOARD_STEPPER_6_REF_ADC    10
